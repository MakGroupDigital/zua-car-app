            ...
            <div className="space-y-4">
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  En utilisant l'application AUTONEX, vous acceptez d'être lié par ces termes et conditions. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  AUTONEX est une plateforme qui permet aux utilisateurs de :
                </p>
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  AUTONEX agit uniquement comme plateforme de mise en relation. Nous ne sommes pas partie aux transactions entre utilisateurs et ne garantissons pas :
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  En publiant du contenu sur AUTONEX, vous accordez à AUTONEX une licence mondiale, non exclusive, gratuite pour utiliser, reproduire et afficher ce contenu dans le cadre du service.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  Tous les droits de propriété intellectuelle sur l'application AUTONEX, y compris mais sans s'y limiter, les logos, marques, et le code source, appartiennent à AUTONEX ou à ses concédants de licence.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">
                  Dans la mesure permise par la loi, AUTONEX ne sera pas responsable des dommages directs, indirects, accessoires ou consécutifs résultant de l'utilisation ou de l'impossibilité d'utiliser le service.
                </p>
              </section>
